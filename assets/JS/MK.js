var game = new Phaser.Game('100%', '100%', 'game');
...
[]
    ...
    preload: function() {
        ...
        this.load.image('ground', 'assets/images/bestground.png');
        this.load.image('platform', 'assets/images/ground (1).png');
        this.load.spritesheet('goalori', 'assets/images/gorilla3 (1).png', 28, 52, 5, 1, 1);
        this.load.spritesheet('goal', 'assets/images/grasshopper.png', 56, 104, 5, 1, 1);
        this.load.spritesheet('goal1.5', 'assets/images/grasshopper1.5.png', 42, 78, 5, 1, 1);
        this.load.image('arrowButton', 'assets/images/arrowButton.png');
        this.load.image('actionButton', 'assets/images/actionButton.png');
        this.load.image('barrel', 'assets/images/barrel.png');
        this.load.image('eniac', 'assets/images/eniac.png');

        // this.load.audio('click', ['/static/audio/click.ogg','/static/audio/click.mp3']);
        // this.load.image('eniac', 'static/img/eniac.png');

        this.load.spritesheet('player', 'assets/images/player.png', 28, 30, 5, 1, 1);
        this.load.spritesheet('playerS1.5', 'assets/images/playerS1.5.png', 42, 45, 5, 1, 1);
        this.load.spritesheet('playerS2', 'assets/images/playerS2.png', 56, 60, 5, 1, 1);
        this.load.spritesheet('playerS1.2', 'assets/images/playerS1.2.png', 56, 60, 5, 1, 1);
        ...
        this.load.image('barrel0.55', 'assets/images/barrel0.55.png');
        this.load.image('barrel0.60', 'assets/images/barrel0.60.png');
        this.load.image('barrel1.5', 'assets/images/barrel1.5.png');
        this.load.image('barrel1.15', 'assets/images/barrel1.15.png');
...
var Gameover = {
    preload: function() {
        this.load.image('eniacLogo', 'assets/images/eniacattacklogo.png');
    },
    create: function() {
